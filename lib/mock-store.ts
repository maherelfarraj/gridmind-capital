...
const SEED_AUDIT: AuditEntry[] = [
  ...
  { id: 'a4', timestamp: '2026-04-01T10:00:00Z', actor: 'Engineering Manager', action: 'WORKFLOW_ACTIVATED', entityType: 'workflow', entityId: 'WF-STAGE-GATE', companyId: 'gmc', result: 'success', details: { workflow: 'G0–G8 Stage Gate' } },
