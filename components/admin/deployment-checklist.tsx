...
const STEPS: Step[] = [
  ...
  {
    id: 9,
    action: 'Run SQL setup script',
    command: null,
    href: 'https://supabase.com/dashboard/project/_/sql/new',
    icon: Database,
    category: 'external',
    detail: 'Open the Supabase SQL Editor, paste the full contents of gridmind-supabase-setup.sql from the project root, and click Run. This creates all tables, RLS policies, triggers, and seed data in one step.',
  },
  {
    id: 10,
    ...
    icon: Sprout,
    category: 'external',
    detail: 'In the Supabase Dashboard go to Authentication → Users and click "Invite user" or "Add user". Use an email you control; the auto-created profile will default to the viewer role — update it to system_admin via Settings → Users inside the app.',
  },
  {
    id: 11,
