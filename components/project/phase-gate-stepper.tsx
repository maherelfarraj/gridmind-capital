...
// ─────────────────────────────────────────────────────────────
// Gate definitions (now using canonical 8-phase names G1–G8)
// ─────────────────────────────────────────────────────────────
...
export const GATE_DEFINITIONS: GateDef[] = [
  {
    id: 1,
    code: 'G1',
    shortName: CANONICAL_PHASE_NAMES[0],
    fullName: `G1 — ${CANONICAL_PHASE_NAMES[0]}`,
    purpose: 'Develop project concept, assess technical and commercial feasibility, and establish business case.',
    phase: 'Origination',
    phaseColor: '#3b82f6',
    keyDeliverables: ['Feasibility Study', 'Business Case', 'Preliminary Design', 'Risk Assessment'],
    typicalDuration: '2–6 weeks',
    approvers: ['Portfolio Committee', 'Project Sponsor'],
  },
  {
    id: 2,
    code: 'G2',
    shortName: CANONICAL_PHASE_NAMES[1],
    fullName: `G2 — ${CANONICAL_PHASE_NAMES[1]}`,
    purpose: 'Secure environmental, grid, and regulatory approvals. Complete permitting process.',
    phase: 'Permitting',
    phaseColor: '#6366f1',
    keyDeliverables: ['Environmental Permit', 'Grid Connection Agreement', 'Regulatory Approvals', 'Land Rights'],
    typicalDuration: '4–12 weeks',
    approvers: ['Regulatory Affairs', 'Grid Operator', 'PMO Director'],
  },
  {
    id: 3,
    code: 'G3',
    shortName: CANONICAL_PHASE_NAMES[2],
    fullName: `G3 — ${CANONICAL_PHASE_NAMES[2]}`,
    purpose: 'Finalize commercial terms, secure financing, and achieve financial close.',
    phase: 'Commercial',
    phaseColor: '#8b5cf6',
    keyDeliverables: ['Signed Contracts', 'Financing Approved', 'Insurance Arranged', 'Final Commercial Terms'],
    typicalDuration: '4–8 weeks',
    approvers: ['Commercial Director', 'Finance Controller', 'Lenders'],
  },
  {
    id: 4,
    code: 'G4',
    shortName: CANONICAL_PHASE_NAMES[3],
    fullName: `G4 — ${CANONICAL_PHASE_NAMES[3]}`,
    purpose: 'Complete detailed design (IFC) and issue for procurement and construction.',
    phase: 'Design',
    phaseColor: '#a855f7',
    keyDeliverables: ['IFC Drawings', 'Technical Specifications', 'BIM Model', 'Design Review Sign-Off'],
    typicalDuration: '6–12 weeks',
    approvers: ['Lead Engineer', 'Design Review Board', 'Client'],
  },
  {
    id: 5,
    code: 'G5',
    shortName: CANONICAL_PHASE_NAMES[4],
    fullName: `G5 — ${CANONICAL_PHASE_NAMES[4]}`,
    purpose: 'Procure major equipment and manufacturing. Establish supply chain.',
    phase: 'Procurement',
    phaseColor: '#f97316',
    keyDeliverables: ['Purchase Orders', 'Vendor Contracts', 'Delivery Schedule', 'Quality Assurance Plan'],
    typicalDuration: '6–18 weeks',
    approvers: ['Procurement Manager', 'Commercial Director', 'Quality Officer'],
  },
  {
    id: 6,
    code: 'G6',
    shortName: CANONICAL_PHASE_NAMES[5],
    fullName: `G6 — ${CANONICAL_PHASE_NAMES[5]}`,
    purpose: 'Execute construction and site installation. Achieve mechanical completion.',
    phase: 'Construction',
    phaseColor: '#fb923c',
    keyDeliverables: ['Mechanical Completion', 'Punch List', 'As-Built Drawings', 'Site Handover'],
    typicalDuration: '6–24 months',
    approvers: ['Construction Manager', 'Site Inspector', 'Client Authority'],
  },
  {
    id: 7,
    code: 'G7',
    shortName: CANONICAL_PHASE_NAMES[6],
    fullName: `G7 — ${CANONICAL_PHASE_NAMES[6]}`,
    purpose: 'Comprehensive system testing, grid compliance verification, and performance validation.',
    phase: 'Commissioning',
    phaseColor: '#f59e0b',
    keyDeliverables: ['Test Reports', 'Grid Code Compliance', 'Performance Certificates', 'O&M Training'],
  ...
  },
  {
    id: 8,
    code: 'G8',
    shortName: CANONICAL_PHASE_NAMES[7],
    fullName: `G8 — ${CANONICAL_PHASE_NAMES[7]}`,
    purpose: 'Formal asset handover to Operations & Maintenance team and commencement of operations.',
    phase: 'Operations',
    phaseColor: '#22c55e',
    keyDeliverables: ['Taking-Over Certificate', 'O&M Manual', 'Warranty Register', 'Operations Commencement'],
    typicalDuration: '1–4 weeks',
    approvers: ['O&M Director', 'Asset Owner', 'Operations Manager'],
  },
]
