...
const MOCK_DEFINITIONS: WorkflowDefinition[] = [
  {
    ...
    steps: [
      { id: 's1', label: 'G1 Origination & Feasibility', type: 'approval', assignedRole: 'PMO Director', slaHours: 48, status: 'done', completedAt: '2026-04-01T09:00:00Z' },
      { id: 's2', label: 'G2 Permitting & Grid Application', type: 'approval', assignedRole: 'Investment Committee', slaHours: 72, status: 'done', completedAt: '2026-05-15T14:00:00Z' },
      { id: 's3', label: 'G3 Commercial & Financial Close', type: 'approval', assignedRole: 'Engineering Director', slaHours: 72, status: 'running', notes: 'Awaiting contract finalization' },
      { id: 's4', label: 'G4 Detailed Design (IFC)', type: 'approval', assignedRole: 'PMO Director', slaHours: 48, status: 'pending' },
